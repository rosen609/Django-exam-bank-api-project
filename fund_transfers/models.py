...
class FundTransfers(models.Model):
    ...
    bank_beneficiary = models.CharField(max_length=200, blank=True, null=True)
    name_beneficiary = models.CharField(max_length=150, blank=True, null=True)
    ...
    otp_generated = models.CharField(max_length=10, blank=True, null=True)
    otp_received = models.CharField(max_length=10, blank=True, null=True)
