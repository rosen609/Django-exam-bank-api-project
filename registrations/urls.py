...
urlpatterns = [
    ...
    path('account_products/', views.AccountProductList.as_view(), name='account_products'),
    path('account_products/<int:pk>/', views.AccountProductDetail.as_view(), name='account_products_detail'),
